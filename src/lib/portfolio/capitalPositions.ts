...
export const capitalPositions: CapitalPosition[] = [
...

  {
    ...
    cautionTags: [
      { label: 'Related-party — same signer on both sides', severity: 'critical-review' },
      { label: 'No external audit or independent valuation cited', severity: 'elevated' },
      { label: 'Payee and Issuer are both controlled by same individual', severity: 'critical-review' },
